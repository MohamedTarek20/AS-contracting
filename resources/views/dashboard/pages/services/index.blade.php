                    ...
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4 me-3">
                            <div class="ms-auto my-auto">
                                <a href="{{ route('admin.services.create') }}" class="btn bg-gradient-dark btn-sm mb-0">+
                                    New Service</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($data as $index => $service)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $service->title_ar }}</span>

                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $service->title_en }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $service->title_zh_cn }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            @if ($service->image)
                                                <img src="{{ $service->image_full_path }}" class="avatar border-radius-lg"
                                                    width="50px" height="50px">
                                            @endif
                                        </td>
                                        <td class="align-middle text-center">
                                            <a class="btn btn-link text-dark px-3 mb-0"
                                                href="{{ route('admin.services.edit', ['service' => $service->id]) }}"><i
