...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link @if (request()->routeIs('admin.dashboard')) active  bg-gradient-dark text-white @else text-dark @endif" href="{{route('admin.dashboard')}}">
                    <i class="material-symbols-rounded opacity-5">dashboard</i>
                    <span class="nav-link-text ms-1">Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (request()->routeIs('admin.sliders.*')) active  bg-gradient-dark text-white @else text-dark @endif" href="{{ route('admin.sliders.index') }}">
                    <i class="material-symbols-rounded opacity-5">window</i>
                    <span class="nav-link-text ms-1">Sliders</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (request()->routeIs('admin.testimonials.*')) active  bg-gradient-dark text-white @else text-dark @endif" href="{{ route('admin.testimonials.index') }}">
